 ...
 */
@WebServlet("/DecryptionController")
public class DecryptionController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String decryptedText=StringEncrypting.Decrypt(request.getParameter("encrypt"), request.getParameter("title"));
		PrintWriter out = response.getWriter();
		out.append(decryptedText);
	}
